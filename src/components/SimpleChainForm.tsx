...
export default function SimpleChainForm() {
                ...
                <VStack gap={"1"}>
                    ...
                    >
                        ...
                        <FormControl marginTop={"3"}>
                            <FormLabel display={"flex"} gap={"3"} alignItems={"baseline"}>
                                <Text>hash</Text>
                    ...
                    >
                        <FormControl>
                            <Tooltip
                                ...
                                hasArrow
                            >
                                <FormLabel width={"fit-content"}>public key</FormLabel>
                            </Tooltip>
                            <Textarea
                                fontSize={"xs"}
                                resize={"none"}
                        ...
                        <FormControl marginY={"3"}>
                            <Tooltip
                                ...
                                hasArrow
                            >
                                <FormLabel width={"fit-content"}>private key</FormLabel>
                            </Tooltip>
                            <Textarea
                                fontSize={"xs"}
                                resize={"none"}
